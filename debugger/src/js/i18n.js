...
const i18n = function (language,cb) {
    var cn = {
            ...
            'oAouh-Tip-p4':'<b>AC Address：</b>和蓝牙路由器交互的服务器地址。请包含HTTP或HTTPS，否则默认使用HTTP。',
        ...
        en = {
            ...
            'oAouh-Tip-p4':'<b>AC Address: </b>The address of the AC Server that interacts with the Bluetooth router. Please include HTTP or HTTPS, otherwise HTTP will be used by default.',
