...
echo_docker_as_nonroot() {
	...
	echo "install Cassia AC"
	docker run -d --name ac --restart always -p 443:443 -p 80:80 -p 8001:8001 -p 9999:9999 -p 5246:5246/udp -p 5247:5247/udp -p 6246:6246/udp -p 6247:6247/udp --mac-address=`cat /sys/class/net/eth0/address` cassia/ac-1.3

	echo "docker container ready, Please access http://ip/"
}
