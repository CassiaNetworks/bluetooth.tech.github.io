const ja = {
  ...
  // MQTT 関連
  mqttConfig: 'Broker 設定',
  mqttTransportType: '通信方式',
  mqttBrokerUrl: 'Host',
  mqttProtocol: 'プロトコル',
  mqttServer: 'サーバー',
  mqttPort: 'ポート',
  ...
  mqttUsername: 'ユーザー名',
  mqttPassword: 'パスワード',
  mqttClientId: 'クライアントID',
  mqttGateway: 'ゲートウェイMAC',
  mqttGatewayMacInvalid: 'ゲートウェイMAC形式が無効です。CC:1B:E0:E3:CD:CCのような大文字形式にしてください',
  mqttKeepalive: 'キープアライブ(s)',
  mqttConnect: '接続',
  mqttDisconnect: '切断',
  mqttConnected: '接続済み',
  mqttDisconnected: '未接続',
  mqttConnecting: '接続中...',
  mqttReconnecting: '再接続中...',
  mqttError: '接続エラー',
  mqttConnectFail: 'MQTT接続に失敗しました',
  mqttConnectOk: 'MQTT接続に成功しました',
  mqttDisconnectOk: 'MQTTが切断されました',
  configSavedButTokenFailed: '設定は保存されましたが、ACトークンの取得に失敗しました',
  mqttLastHeartbeat: 'ハートビート',
  mqttGatewayModel: 'モデル',
  mqttGatewayVersion: 'バージョン',
  mqttGatewayUptime: '稼働時間',
  mqttGatewayUplink: 'アップリンク',
  mqttGatewayIp: 'IPアドレス',
  mqttScanConfigHint: 'MQTTモードではスキャンパラメータはゲートウェイ側で設定する必要があります',
  mqttReceiveData: 'データ受信',
  mqttStopReceive: '受信停止',
  mqttReceivingData: 'スキャンデータを受信中',
  mqttStoppedReceiving: 'スキャンデータの受信を停止しました',
  mqttRequestTimeout: 'API応答待ちタイムアウト',
  mqttStatus: 'MQTTステータス',
  mqttGatewayStatus: 'ゲートウェイ状態',
  mqttSecondsAgo: '秒前',
  mqttMinutesAgo: '分前',
  mqttHoursAgo: '時間前',
  mqttNoHeartbeat: '未受信',
  mqttGatewayOffline: 'ゲートウェイがオフライン（ハートビートタイムアウト）、接続リストをクリアしました',
  mqttNotConnectedHint: 'MQTTモードに切り替えました。MQTT Brokerに接続しますか？',
};
