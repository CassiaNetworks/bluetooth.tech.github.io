const cn = {
  ...
  mqttClientId: '客户端ID',
  mqttGateway: '网关MAC',
  mqttGatewayMacInvalid: '网关MAC格式错误，应为大写格式如 CC:1B:E0:E3:CD:CC',
  mqttKeepalive: '心跳间隔(s)',
  mqttConnect: '连接',
  mqttDisconnect: '断开',
  mqttConnected: '已连接',
  mqttDisconnected: '未连接',
  mqttConnecting: '连接中...',
  mqttReconnecting: '重连中...',
  mqttError: '连接错误',
  mqttConnectFail: 'MQTT连接失败',
  mqttConnectOk: 'MQTT连接成功',
  mqttDisconnectOk: 'MQTT已断开',
  configSavedButTokenFailed: '配置已保存，但AC Token获取失败',
  mqttLastHeartbeat: '心跳',
  mqttGatewayModel: '型号',
  mqttGatewayVersion: '版本',
  mqttGatewayUptime: '运行时间',
  mqttGatewayUplink: '上行链路',
  mqttGatewayIp: 'IP地址',
  mqttScanConfigHint: 'MQTT模式下扫描参数需在网关侧配置',
  mqttReceiveData: '接收数据',
  mqttStopReceive: '停止接收',
  mqttReceivingData: '正在接收扫描数据',
  mqttStoppedReceiving: '已停止接收扫描数据',
  mqttRequestTimeout: '等待API回复超时',
  mqttStatus: 'MQTT状态',
  mqttGatewayStatus: '网关状态',
  mqttSecondsAgo: '秒前',
  mqttMinutesAgo: '分钟前',
  mqttHoursAgo: '小时前',
  mqttNoHeartbeat: '未收到',
  mqttGatewayOffline: '网关离线（心跳超时），已清空连接列表',
  mqttNotConnectedHint: '已切换到MQTT模式，是否立即连接MQTT Broker？',
};
