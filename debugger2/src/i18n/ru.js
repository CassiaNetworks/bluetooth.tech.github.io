const ru = {
  ...
  // MQTT related
  mqttConfig: 'Настройки Broker',
  mqttTransportType: 'Транспорт',
  mqttBrokerUrl: 'Хост',
  mqttProtocol: 'Протокол',
  mqttServer: 'Сервер',
  mqttPort: 'Порт',
  mqttPath: 'Путь',
  mqttProtocol: 'Протокол',
  ...
  mqttPassword: 'Пароль',
  mqttClientId: 'ID Клиента',
  mqttGateway: 'MAC Шлюза',
  mqttGatewayMacInvalid: 'Неверный формат MAC шлюза, должен быть в верхнем регистре, например CC:1B:E0:E3:CD:CC',
  mqttKeepalive: 'Keepalive(s)',
  mqttConnect: 'Подключить',
  mqttDisconnect: 'Отключить',
  mqttConnected: 'Подключено',
  mqttDisconnected: 'Отключено',
  mqttConnecting: 'Подключение...',
  mqttReconnecting: 'Переподключение...',
  mqttError: 'Ошибка подключения',
  mqttConnectFail: 'Ошибка подключения MQTT',
  mqttConnectOk: 'MQTT подключен успешно',
  mqttDisconnectOk: 'MQTT отключен',
  configSavedButTokenFailed: 'Конфигурация сохранена, но не удалось получить токен AC',
  mqttLastHeartbeat: 'Heartbeat',
  mqttGatewayModel: 'Модель',
  mqttGatewayVersion: 'Версия',
  mqttGatewayUptime: 'Время работы',
  mqttGatewayUplink: 'Uplink',
  mqttGatewayIp: 'IP Адрес',
  mqttScanConfigHint: 'Параметры сканирования должны быть настроены на шлюзе в режиме MQTT',
  mqttReceiveData: 'Получить данные',
  mqttStopReceive: 'Остановить получение',
  mqttReceivingData: 'Получение данных сканирования',
  mqttStoppedReceiving: 'Получение данных сканирования остановлено',
  mqttRequestTimeout: 'Таймаут ожидания ответа API',
  mqttStatus: 'Статус MQTT',
  mqttGatewayStatus: 'Статус шлюза',
  mqttSecondsAgo: 'сек назад',
  mqttMinutesAgo: 'мин назад',
  mqttHoursAgo: 'ч назад',
  mqttNoHeartbeat: 'Нет heartbeat',
  mqttGatewayOffline: 'Шлюз офлайн (таймаут heartbeat), список подключений очищен',
  mqttNotConnectedHint: 'Переключено на режим MQTT. Подключиться к MQTT Broker сейчас?',
};
