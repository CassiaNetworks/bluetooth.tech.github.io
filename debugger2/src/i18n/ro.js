const ro = {
  ...
  // MQTT related
  mqttConfig: 'Configurare Broker',
  mqttTransportType: 'Transport',
  mqttBrokerUrl: 'Host',
  ...
  mqttServer: 'Server',
  mqttPort: 'Port',
  mqttUsername: 'Nume utilizator',
  mqttPassword: 'Parola',
  mqttClientId: 'ID Client',
  mqttGateway: 'Gateway MAC',
  mqttGatewayMacInvalid: 'Format Gateway MAC invalid, trebuie sa fie majuscule precum CC:1B:E0:E3:CD:CC',
  mqttKeepalive: 'Keepalive(s)',
  mqttConnect: 'Conectare',
  mqttDisconnect: 'Deconectare',
  mqttConnected: 'Conectat',
  mqttDisconnected: 'Deconectat',
  mqttConnecting: 'Se conecteaza...',
  mqttReconnecting: 'Se reconecteaza...',
  mqttError: 'Eroare de conexiune',
  mqttConnectFail: 'Conexiunea MQTT a esuat',
  mqttConnectOk: 'MQTT conectat cu succes',
  mqttDisconnectOk: 'MQTT deconectat',
  configSavedButTokenFailed: 'Configurația a fost salvată, dar obținerea token-ului AC a eșuat',
  mqttLastHeartbeat: 'Heartbeat',
  mqttGatewayModel: 'Model',
  mqttGatewayVersion: 'Versiune',
  mqttGatewayUptime: 'Timp functionare',
  mqttGatewayUplink: 'Uplink',
  mqttGatewayIp: 'Adresa IP',
  mqttScanConfigHint: 'Parametrii de scanare trebuie configurati pe gateway in modul MQTT',
  mqttReceiveData: 'Primire date',
  mqttStopReceive: 'Oprire primire',
  mqttReceivingData: 'Se primesc date de scanare',
  mqttStoppedReceiving: 'Primirea datelor de scanare oprita',
  mqttRequestTimeout: 'Timeout asteptare raspuns API',
  mqttStatus: 'Status MQTT',
  mqttGatewayStatus: 'Stare Gateway',
  mqttSecondsAgo: 's in urma',
  mqttMinutesAgo: 'min in urma',
  mqttHoursAgo: 'h in urma',
  mqttNoHeartbeat: 'Fara heartbeat',
  mqttGatewayOffline: 'Gateway offline (timeout heartbeat), lista conexiuni golita',
  mqttNotConnectedHint: 'S-a comutat la modul MQTT. Conectați la MQTT Broker acum?',
};
