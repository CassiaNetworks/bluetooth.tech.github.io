const en = {
  ...
  mqttGatewayMacInvalid: 'Gateway MAC format invalid, should be uppercase like CC:1B:E0:E3:CD:CC',
  ...
  mqttConnectFail: 'MQTT connection failed',
  mqttConnectOk: 'MQTT connected successfully',
  mqttDisconnectOk: 'MQTT disconnected',
  configSavedButTokenFailed: 'Config saved, but AC token fetch failed',
  mqttLastHeartbeat: 'Heartbeat',
  mqttGatewayModel: 'Model',
  mqttGatewayVersion: 'Version',
  mqttGatewayUptime: 'Uptime',
  mqttGatewayUplink: 'Uplink',
  mqttGatewayIp: 'IP Address',
  mqttScanConfigHint: 'Scan parameters need to be configured on the gateway side in MQTT mode',
  mqttReceiveData: 'Receive Data',
  mqttStopReceive: 'Stop Receiving',
  mqttReceivingData: 'Receiving scan data',
  mqttStoppedReceiving: 'Stopped receiving scan data',
  mqttRequestTimeout: 'Wait for API reply timeout',
  mqttStatus: 'MQTT Status',
  mqttGatewayStatus: 'Gateway Status',
  mqttSecondsAgo: 's ago',
  mqttMinutesAgo: 'min ago',
  mqttHoursAgo: 'h ago',
  mqttNoHeartbeat: 'No heartbeat',
  mqttGatewayOffline: 'Gateway offline (heartbeat timeout), connections cleared',
  mqttNotConnectedHint: 'Switched to MQTT mode. Connect to MQTT Broker now?',
};
