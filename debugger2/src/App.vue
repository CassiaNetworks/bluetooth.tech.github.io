    ...
    <el-container style="height: 100%">
      ...
      <el-container>
        ...
        <el-drawer
          ...
          :visible.sync="store.devConfDisplayVars.isConfigMenuItemOpen"
          direction="ltr"
          size="326px">
          <template slot="title">
            <span></span>
                ...
                <el-form label-width="85px" size="small" :model="store.devConf" :rules="cache.devConfRules">
                  ...
                  <el-form-item :label="$t('message.connectStyle')" style="margin-top: 15px;">
                    <el-radio-group v-model="store.devConf.controlStyle">
                      <el-radio-button label="AP"></el-radio-button>
          ...
          <el-container style="height: 100%; background-color: #fff;">
            ...
            <el-row style="margin: 0 0 0 150px; height: 100%; width: 100%;" v-show="store.devConfDisplayVars.activeMenuItem === 'apiDebuggerMenuItem'">
              <el-aside class="apiDebuggerMenu" :width="store.devConfDisplayVars.language === 'cn' ? '110px' : '150px'" style="height: 100%; background-color: #FFF; box-shadow:-1px 0px 6px 0px rgba(195,212,227,0.28); position: fixed; z-index: 999; border-right: 1px solid #ebedf2">
                ...
                <el-menu
                  :collapse="false"
                  @select="apiDebuggerMenuSelect"
                  background-color="#fff"
                  text-color="#505050"
                  active-text-color="#0089ff"
                  :default-active="store.devConfDisplayVars.activeApiDebugMenuItem"
                  ref="refApiDebuggerMenu"
                  class="el-menu-api-debugger">
                ...
                <el-col :span="18" style="height: 100%; border-right: 1px solid #ebedf2; padding-top: 10px;">
                  ...
                  <el-row style="box-shadow:0px 0px 5px 0px rgba(214,214,214,0.49); border-radius:1px; padding: 15px; width: 98%; ">
                    <el-menu
                      :collapse="false"
                      mode="horizontal"
                      @select="apiDebuggerOutputMenuSelect"
                      background-color="#fff"
                      text-color="#505050"
                      active-text-color="#505050"
                      default-active="output"
                      ref="apiDebuggerOutputMenu"
                      class="apiDebuggerOutputMenu">
            ...
            <el-row style="margin: 0 0 0 150px; height: 100%; width: 100%; " v-show="store.devConfDisplayVars.activeMenuItem === 'apiDemoMenuItem'">
              <el-aside class="apiDebuggerMenu" width="110px" style="height: 100%; background-color: #FFF; box-shadow:-1px 0px 6px 0px rgba(195,212,227,0.28); position: fixed; z-index: 999; border-right: 1px solid #ebedf2">
                ...
                <el-menu
                  :collapse="false"
                  @select="apiDebuggerDemoMenuSelect"
                  background-color="#fff"
                  text-color="#505050"
                  active-text-color="#0089ff"
                  default-active="demo1"
                  ref="apiDebuggerDemoMenu"
                  class="el-menu-api-demo">
...
.el-menu-api-demo, .el-menu-api-debugger {
  width: 100%;
  height: 100%;
  border: 0;
}
...
.vxe-button.type--button.theme--primary:not(.is--disabled), .el-radio-button__orig-radio:checked+.el-radio-button__inner, .el-button--primary {
  background-color: #0089ff;
  border-color: #0089ff;
}
