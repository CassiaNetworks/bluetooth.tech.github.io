...
`,e.jsx(n.h2,{id:"cursor使用",children:e.jsx(n.a,{href:"#cursor使用",children:"Cursor使用"})}),`
...
`,e.jsx("br",{}),`
`,e.jsx("br",{})]})}function t(s={}){const{wrapper:n}=s.components||{};return n?e.jsx(n,{...s,children:e.jsx(a,{...s})}):a(s)}function l(s,n){throw new Error("Expected component `"+s+"` to be defined: you likely forgot to import, pass, or provide it.")}export{t as default,i as frontmatter};
