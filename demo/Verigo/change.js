...
macs = $('.devMac').val().split(',')
hub_mac = $('.hubIp').val().split(',')
console.log("asd",$('.devMac').val())
...
$('.Scan').on('click' , function () {
    ...
    .oauth2({
        success: function (hub,macs) {
            api
            .scan({})
            .on('scan', function(){
            	for (var i = 0; i < macs.length; i++) {
            		scanFirst(hub,macs[i])
            	}
            })
        }
    });
...
scanFirst = function(hub, device_mac){
    ...
    $('.content').append("<div class='content1 clearfix' name="+device_mac.toUpperCase()+"><ul class='date' name="+device_mac.toUpperCase()+"><li><span>Customer Tag:</span><span class='user'></span></li><li><span>Status：</span><span class='status'></span></li><li><span>Vrms X：</span><span class='V_X'></span></li><li><span>Vrms Y：</span><span class='V_Y'></span></li><li><span>Vrms Z：</span><span class='V_Z'></span></li><li><span>Battery:</span><span class='battery'></span></li><li><span>Temperature:</span><span class='temp'></span></li><li><span>Device Type:</span><span class='type'></span></li><li><span>Hours Running:</span><span class='hour'></span></li></ul><button class='btn2' id=raw"+device_mac.toUpperCase()+">Rawdata</button><div class='canvas'><div id="+device_mac.toUpperCase()+" style='width: 450px;height:300px;'></div></div><div class='canvas'><div id="+device_mac.toUpperCase()+"a"+" style='width: 450px;height:300px;'></div></div><div class='canvas'><div id='mainx"+device_mac.toUpperCase()+"' style='width: 450px;height:300px;'></div></div><div class='canvas'><div id='mainy"+device_mac.toUpperCase()+"' style='width: 450px;height:300px;'></div></div><div class='canvas'><div id='mainz"+device_mac.toUpperCase()+"' style='width: 450px;height:300px;'></div></div><div class='canvas'><div id='fftx"+device_mac.toUpperCase()+"' style='width: 450px;height:300px;'></div></div><div class='canvas'><div id='ffty"+device_mac.toUpperCase()+"' style='width: 450px;height:300px;'></div></div><div class='canvas'><div id='fftz"+device_mac.toUpperCase()+"' style='width: 450px;height:300px;'></div></div></div>")
...
connectFirst = function(mas,hub,data){
	api
		.on('notify',function(hub, data){
            ...
            if(rawData.match("00000000")){
                ...
                if(notifyData[deviceMac].point >= 2){
                    ...
                    console.log("datadatadata::",deviceMac,notifyData[deviceMac].data);
